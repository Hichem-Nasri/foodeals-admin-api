    ...
    public void configureModelMapper() {
        ...
        modelMapper.addConverter(context -> {
            ...
            if(user.getRole()!=null) {
             roleResponse = modelMapper.map(user.getRole(), RoleResponse.class);
            }
            System.out.println("user converter is working");
            System.out.println(user.getRole());

            return new UserResponse(user.getId(), user.getName(), user.getEmail(), user.getPhone(), roleResponse, user.getOrganizationEntity()!=null ?user.getOrganizationEntity().getId():null);
