...
public class User extends AbstractEntity<Integer> implements UserDetails {
    ...
    @Column(name = "gross_declaration")
    private Double grossDeclaration;

    @Column(name = "net_declaration")
    private Double netDeclaration;

    @Column(name = "contract_type")
    private String contractType;

    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<UserPersonalDocument> personalDocuments=new ArrayList<>();

    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<UserInternalDocument> internalDocuments=new ArrayList<>();
    ...
    public User setRadius(int raduis) {
        this.radius = raduis;
        return this;
    }
    public User setVehicleType(VehicleType vehicleType) {
    ...
    public User setMotif(String motif) {
        this.source =source;
        return this;
    }
    
    public User setResponsible(User responsible) {
    	this.responsible=responsible;
    	return this;
    }
    
    public User setGrossDeclaration(Double grossDeclaration) {
    	this.grossDeclaration=grossDeclaration;
    	return this;
    }
    
    public User setNetDeclaration(Double netDeclaration) {
    	this.netDeclaration=netDeclaration;
    	return this;
    }
	...
	public User setPersonalDocuments(List<UserPersonalDocument> personalDocs) {
		this.personalDocuments=personalDocs;
		return this;
		
	}
	
	public User setInternalDocuments(List<UserInternalDocument> internalDocs) {
		this.internalDocuments=internalDocs;
		return this;
