...
public interface OrderService extends CrudService<Order, UUID, OrderRequest> {
    ...
    OrderListResponseDto getOrdersWithStats(Pageable pageable);
    
    OrderListResponseDto getOrdersWithStats(Pageable pageable, String clientType);

    OrderDetailsDTO getOrderDetails(UUID id);
    
    Page<OrderSummaryDto> getOrdersForClient(String clientId, String clientType, Pageable pageable);
    
    Page<OrderSummaryDto> searchOrders(String name, Pageable pageable);
