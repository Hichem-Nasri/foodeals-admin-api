...
public class CouponServiceImpl implements CouponService {
    ...
    public Coupon update(UUID id, CouponRequest request) {
        ...
        coupon.setIsEnabled(request.isEnabled());
    ...
    @Override
    public List<CouponSummaryDto> searchCoupons(String name, String code, Boolean isEnabled, Float minDiscount, Float maxDiscount, Date start, Date end) {
        return repository.searchCouponsWithFilters(name, code, isEnabled, minDiscount, maxDiscount, start, end);
    }
}
